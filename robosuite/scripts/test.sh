...
#    --load_path '/home/yeweirui/code/robosuite/robosuite/scripts/results/baselines/image_ppo2_cnn_2layer_0.001lr_256stpes_8async_0.01explore__64x64_2view/checkpoints/00200' \
#    --use_camera_obs True \
#    --camera_height 64 \
#    --camera_width 64 \
